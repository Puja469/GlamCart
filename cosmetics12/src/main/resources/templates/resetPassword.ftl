...
<table width="600" style="font-family: Arial, Helvetica, sans-serif; font-size: 0.875rem; color: rgb(51, 51, 51);">
    ...
    <tr>
        <td style="padding: 32px 48px 0 48px;">
            <div style="float: left; margin-left: 16px;">
                <p style="color:rgb(189, 9, 18); font-size: 16px; font-weight: 600; margin-bottom: 8px; margin-top: 8px;">GlamCart</p>
    ...
    <tr>
        <td style="padding: 1rem 48px 1.5rem 48px">For additional help or information, email us at <a href="#" style="color: rgb(26, 115, 232)">www.glamcart.com.np</a> </td>
    </tr>
    <tr>
